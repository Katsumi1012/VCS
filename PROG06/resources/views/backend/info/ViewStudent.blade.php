    ...
    <div class="card student-card">
        <div class="card-body">
            ...
            <div class="mt-4 flex justify-end">
                <a href="{{ route('info.ShowStudent', $student->id) }}" class="btn btn-sm btn-primary">
                    <i class="fas fa-eye btn-icon"></i>
                    <span>View Details</span>
                </a>
                <a href="{{ route('message.sendmessage', $student->user->id) }}" class="btn btn-sm btn-light ml-2">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        searchInput.addEventListener('input', function() {
            ...
            studentCards.forEach(card => {
                ...
                const studentEmail = card.querySelector('.profile-info-value').textContent.toLowerCase();
